  ...
  const clientReviews = [
    {
      ...
      title: t("about.reviews.client1.title"),
      rating: 5,
    ...
    },
    {
      ...
      title: t("about.reviews.client2.title"),
      rating: 5,
    ...
    },
    {
      ...
      title: t("about.reviews.client3.title"),
      rating: 5,
    ...
    },
    {
      ...
      title: t("about.reviews.client4.title"),
      rating: 5,
    ...
    },
    {
      ...
      title: t("about.reviews.client5.title"),
      rating: 5,
    ...
    },
    {
      ...
      title: t("about.reviews.client6.title"),
      rating: 4,
                      ...
                      <div className="bg-white shadow-lg rounded-2xl overflow-hidden p-8 flex flex-col items-center text-center">
                        <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-green-200 mb-6">
                          <img
                            ...
                            alt={t("about.partners.constructionPartner.name")}
                            className="w-full h-full object-cover"
                          />
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 mb-2">
                          {t("about.partners.constructionPartner.name")}
                        </h3>
                        <p className="text-gray-600">
                          {t("about.partners.constructionPartner.description")}
                        </p>
                      </div>
                      ...
                      <div className="bg-white shadow-lg rounded-2xl overflow-hidden p-8 flex flex-col items-center text-center">
                        <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-green-200 mb-6">
                          <img
                            ...
                            alt={t("about.partners.webdevPartner.name")}
                            className="w-full h-full object-cover"
                          />
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 mb-2">
                          {t("about.partners.webdevPartner.name")}
                        </h3>
                        <p className="text-gray-600">
                          {t("about.partners.webdevPartner.description")}
                        </p>
                      </div>
                    </div>
                  </div>
